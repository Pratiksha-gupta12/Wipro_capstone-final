...
//     test('TC_CART_VAL_001 - Verify Cart URL', async ({ page }) => {
//         await expect(page).toHaveURL(/cart/);
//     });

//     test('TC_CART_VAL_002 - Verify Shopping Cart Title', async ({ page }) => {
//         await expect(page.locator('.page-title'))
//             .toContainText('Shopping cart');
//     });

//     test('TC_CART_VAL_003 - Verify Cart Page Is Visible', async ({ page }) => {
//         await expect(page.locator('body'))
//             .toContainText('Shopping cart');
//     });

//     test('TC_CART_VAL_004 - Verify Empty Cart Message', async ({ page }) => {
//         await expect(page.locator('.order-summary-content'))
//             .toContainText('Your Shopping Cart is empty');
//     });

//     test('TC_CART_VAL_005 - Verify Continue Shopping Link Exists', async ({ page }) => {
//         await expect(
//             page.getByRole('link', { name: /Books/i })
//         ).toBeVisible();
//     });

//     test('TC_CART_VAL_006 - Verify Page Loads Without Errors', async ({ page }) => {

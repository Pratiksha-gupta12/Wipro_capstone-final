...
test.describe('Login Tests', () => {
    ...
    test('TC_AUTH_006 - Verify Login With Valid Credentials',
        async ({ page, authPage }) => {
    ...
    test('TC_AUTH_007 - Verify Login With Invalid Password',
        async ({ authPage }) => {
    ...
    test('TC_AUTH_008 - Verify Login With Unregistered Email',
        async ({ authPage }) => {
    ...
    test('TC_AUTH_009 - Verify Login With Empty Credentials',
        async ({ authPage }) => {
    ...
    test('TC_AUTH_010 - Verify Remember Me Functionality',
        async ({ page, authPage }) => {

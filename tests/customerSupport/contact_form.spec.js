...
//     test('TC_CS_FORM_001 - Submit Valid Enquiry', async () => {

//         await supportPage.submitEnquiry(
//             'Pratiksha',
//             'test@example.com',
//             'This is a test enquiry'
//         );

//         await expect(supportPage.successMessage)
//             .toBeVisible();
//     });

//     test('TC_CS_FORM_002 - Verify Success Message', async () => {
...
//     test('TC_CS_FORM_003 - Verify Name Field Accepts Input', async () => {

//         await supportPage.nameField.fill('Pratiksha');

//         await expect(supportPage.nameField)
//             .toHaveValue('Pratiksha');
//     });

//     test('TC_CS_FORM_004 - Verify Email Field Accepts Input', async () => {

//         await supportPage.emailField.fill('test@example.com');

//         await expect(supportPage.emailField)
//             .toHaveValue('test@example.com');
//     });

//     test('TC_CS_FORM_005 - Verify Enquiry Field Accepts Input', async () => {

//         await supportPage.enquiryField.fill('Testing enquiry');

//         await expect(supportPage.enquiryField)
//             .toHaveValue('Testing enquiry');
//     });

//     test('TC_CS_FORM_006 - Verify Submit Button Clickable', async () => {
